...
interface InvoiceItem {
    ...
    total?: number; // Optional for calculations
    discount?: number; // Optional for calculations
    ordred?: string; // Optional for date
    dueDate?: string; // Optional for date
    status?: string; // Optional for status
    note?: string; // Optional for notes
}
