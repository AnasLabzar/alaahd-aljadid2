      ...
      },
      {
        icon: (
          <svg className="fill-current"
            width="24"
            height="24" id="Layer_1" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1"><path d="m22.591 8.18h-7.514a.75.75 0 1 0 0 1.5h7.514a.75.75 0 0 0 0-1.5z" /><path d="m10.377 7.343-1.76 1.8-.671-.683a.75.75 0 1 0 -1.074 1.047l.827.848a1.279 1.279 0 0 0 1.836 0l1.916-1.965a.75.75 0 1 0 -1.074-1.047z" /><path d="m22.591 14.25h-7.514a.75.75 0 1 0 0 1.5h7.514a.75.75 0 0 0 0-1.5z" /><path d="m10.377 13.413-1.76 1.8-.671-.688a.75.75 0 0 0 -1.074 1.047l.827.849a1.281 1.281 0 0 0 1.836 0l1.916-1.965a.75.75 0 1 0 -1.074-1.047z" /><path d="m22.591 20.32h-7.514a.75.75 0 1 0 0 1.5h7.514a.75.75 0 0 0 0-1.5z" /><path d="m10.377 19.483-1.76 1.806-.671-.689a.75.75 0 0 0 -1.074 1.046l.827.85a1.279 1.279 0 0 0 1.836 0l1.916-1.966a.75.75 0 0 0 -1.074-1.047z" /><path d="m28.163 25v-20a4.756 4.756 0 0 0 -4.75-4.75h-16.826a4.756 4.756 0 0 0 -4.75 4.75v20a4.756 4.756 0 0 0 4.75 4.75h16.826a4.756 4.756 0 0 0 4.75-4.75zm-24.826 0v-20a3.254 3.254 0 0 1 3.25-3.25h16.826a3.254 3.254 0 0 1 3.25 3.25v20a3.254 3.254 0 0 1 -3.25 3.25h-16.826a3.254 3.254 0 0 1 -3.25-3.25z" /></svg>
        ),
      ...
      },
      {
        icon: (
          <svg className="text- fill-current"
            ...
            height="24"
            viewBox="0 0 384 512"
            fill="none" xmlns="http://www.w3.org/2000/svg" ><path d="M64 464c-8.8 0-16-7.2-16-16L48 64c0-8.8 7.2-16 16-16l160 0 0 80c0 17.7 14.3 32 32 32l80 0 0 288c0 8.8-7.2 16-16 16L64 464zM64 0C28.7 0 0 28.7 0 64L0 448c0 35.3 28.7 64 64 64l256 0c35.3 0 64-28.7 64-64l0-293.5c0-17-6.7-33.3-18.7-45.3L274.7 18.7C262.7 6.7 246.5 0 229.5 0L64 0zm56 256c-13.3 0-24 10.7-24 24s10.7 24 24 24l144 0c13.3 0 24-10.7 24-24s-10.7-24-24-24l-144 0zm0 96c-13.3 0-24 10.7-24 24s10.7 24 24 24l144 0c13.3 0 24-10.7 24-24s-10.7-24-24-24l-144 0z" /></svg>
        ),
        label: "Factures",
        route: "/invoice",
        children: [
